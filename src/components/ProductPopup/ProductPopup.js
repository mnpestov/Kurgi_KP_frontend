...
//         countOfProduct: "",
//         priceOfProduct: "",
//         typeOfProduct: "eat", // 'eat' | 'drink' | 'organisation'
//     });

//     // Флаги и состояние выбранного элемента каталога
//     const [isAuto, setIsAuto] = useState(false);
//     const [selectedProduct, setSelectedProduct] = useState(null); // { id, name, composition, type } | null
...
//             // если редактируемая позиция пришла с productId — считаем, что она из каталога
//             if (productToEdit.productId) {
//                 setSelectedProduct({
//                     id: productToEdit.productId,
//                     name: productToEdit.product,
//                     composition: productToEdit.composition,
//                     type: productToEdit.typeOfProduct,
//                 });
//                 setIsAuto(true);
//             } else {
...
//             s.startsWith('напит') ||
//             s.startsWith('drink') ||
//             s.startsWith('напитки') ||
//             s.startsWith('напиток')
//         ) return 'drink';
//         if (
//             s.startsWith('организ') ||
//             s.startsWith('логист') ||
...
//                                 // Пользователь начал печатать вручную
//                                 if (selectedProduct && text === selectedProduct.name) return;
//                                 if (selectedProduct) setSelectedProduct(null);
//                                 if (isAuto) setIsAuto(false);
//                                 setProductData(prev => ({ ...prev, product: text }));
//                             }}
//                         />
//                         {isAuto && (
